...
def insert_todo(todo: Todo):
    ...
    with conn:
        c.execute('INSERT INTO todos VALUES (:task, :category, :date_added, :date_completed, :date_due, :status, :postiion)',
                  {'task': todo.task, 'category': todo.category, 'date_added': todo.date_added,
                   'date_completed': todo.date_completed, 'date_due': todo.date_due, 'status': todo.status, 'position': todo.position})
